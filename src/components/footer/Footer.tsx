...
const Footer = () => {
    ...
    return (
        <footer className={`${styles.footer} w-100 m-0`}>
            <Container className="w-100 py-5 py-sm-2 ">
                ...
                <span className="d-none d-md-flex justify-content-center align-items-center copyright">© {year} <a href="#" >Ride Share Tracker.™</a> All Rights Reserved.</span>
            </Container>
        </footer>
    );
};
